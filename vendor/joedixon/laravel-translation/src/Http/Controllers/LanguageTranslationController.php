...
class LanguageTranslationController extends Controller
{
    ...
    public function index(Request $request, $language)
    {
        ...
        if ($request->has('language') && $request->get('language') !== $language) {
            return redirect()
                ->route('languages.translations.translation-index', ['language' => $request->get('language'), 'group' => $request->get('group'), 'filter' => $request->get('filter')]);
        }
        ...
        return view('translation::languages.translations.translation-index0', compact('language', 'languages', 'groups', 'translations'));
    }

    public function create(Request $request, $language)
    {
        return view('translation::languages.translations.translation-create', compact('language'));
    }
    ...
    public function store(TranslationRequest $request, $language)
    {
        ...
        notify()->success('Translation added successfully');
        return redirect()
