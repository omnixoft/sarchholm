                ...
                <div class="col-md-12">
                    <div class="db-add-list-wrap">
                        ...
                        <div class="db-add-listing">
                            <form action="{{ route('admin.inventory.update',$row->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="project_id" class="listing-input hero__form-input  form-control custom-select select-project {{ $errors->has('building_id') ? 'has-error' : '' }}">
                                                ...
                                                @foreach ($Projects as $b)
                                                    <option value="{{$b->id}}" {{$b->id == $row->project_id ? 'selected' : ''}} >{{$b->name}}</option>
                                                @endforeach
                                            </select>
                                            @error('project_id')
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group select-project-building">
                                            ...
                                            <select name="building_id"
                                                ...
                                                <option value="{{$row->building_id}}" selected >{{$row->building->name}}</option>
                                            </select>
                                            @error('building_id')
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sqm" value="{{ $row->sqm }}" class="form-control filter-input"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="price" value="{{ $row->price }}" class="form-control filter-input"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="discount_price" value="{{ $row->discount_price }}" class="form-control filter-input"
                                    ...
                                    @endphp
                                    <input type="hidden" name="eximgs" value="{{ $row->image }}">
                                    @foreach ($imgs as $key => $img)
                                    <div class="col-md-6">
                                        <div class="form-group col-md-6 img-box-divvv">
                                            <div class="white-box-divv"
                                                style="position: relative; background-image:url('{{ asset('inventory/'.$img) }}'); background-size:cover; height: 130px; box-shadow: rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px;, rgb(0 0 0 / 30%) 0px 3px 7px -3px;">
                                                @if ($key > 0)
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" class="form-control filter-input" placeholder="Description" cols="30" rows="10">{{ $row->description }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Unit Material:</label>@include('required')
                                            <input type="text" name="material" value="{{ $row->material }}" class="form-control filter-input"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="available" class="listing-input hero__form-input  form-control custom-select">
                                                ...
                                                <option value="1" {{ $row->available == 1 ? 'selected' : '' }} >Available</option>
                                                <option value="0" {{ $row->available == 0 ? 'selected' : '' }} >Not Available</option>
                                            </select>
                                            @error('available')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
