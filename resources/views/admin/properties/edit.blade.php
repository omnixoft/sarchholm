                            ...
                            <div class="row mb-30">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="floor" class="listing-input hero__form-input  form-control custom-select">
                                        ...
                                        <option value="Second Floor" @if(isset($property->propertyDetails->floor)) {{$property->propertyDetails->floor == 'Second Floor' ? 'selected' : ''}} @endif>Second Floor</option>
                                        <option value="Third Floor" @if(isset($property->propertyDetails->floor)) {{$property->propertyDetails->floor == 'Third Floor' ? 'selected' : ''}} @endif>Third Floor</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
