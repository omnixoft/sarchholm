                ...
                <div class="col-md-12">
                    ...
                    <div class="db-add-list-wrap">
                        ...
                        <div class="db-add-listing">
                            <form action="{{route('admin.header-images.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="page" id="" class="form-control">
                                            ...
                                            <option value="single-agent">Single Agents</option>
                                            <option value="news">News</option>
                                            <option value="single-news">Single News</option>
