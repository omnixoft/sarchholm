                ...
                <div class="col-md-12">
                    ...
                    <div class="db-add-list-wrap">
                        ...
                        <div class="db-add-listing">
                            <form action="{{ route('admin.client-units.update',$row->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="project_id"
                                            ...
                                            @foreach ($projects as $u)
                                                <option value="{{ $u->id }}" {{ $u->id ==  $row->project_id ? 'selected' : '' }} >{{ $u->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" name="phone" value="{{ $row->phone }}" class="form-control filter-input"
